...
use linux_raw_sys::general::{
    ...
    __NR_pwrite64, __NR_read, __NR_readlinkat, __NR_sched_yield, __NR_symlinkat, __NR_unlinkat,
...
use linux_raw_sys::v5_4::general::{
    __NR_copy_file_range, __NR_eventfd2, __NR_getrandom, __NR_memfd_create, __NR_renameat2,
